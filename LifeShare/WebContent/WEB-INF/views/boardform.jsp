                        ...
                        <form action="upload" enctype="multipart/form-data" method="post">
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    <label>제목</label>
                                    <input class="form-control" id="title" name="title" type="text" placeholder="ex)청소기 나눔합니다~" required="required">
                            ...
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    <label>거래 타입</label>
                                    <select name="btype" class="form-control" id="btype" required="required" >
                                    	<option value="교환">교환
 										<option value="나눔">나눔
                                    </select>
                                </div>
                            ...
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    <label>지역 선택(구단위)</label>
                                    <select name="loc" class="form-control" id="loc" required="required" >
                                    <option value="서울시" selected>--서울시--
									<option value="강서구">강서구
									<option value="양천구">양천구
									<option value="구로구">구로구
                            ...
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    <label>지역 입력(세부지역)</label>
                                    <input class="form-control" id="loc2" name="loc2" type="text" placeholder="ex)월곡" required="required">
                            ...
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    <label>내용</label>
                                    <textarea class="form-control" id="content" name="content" rows="5" placeholder="Content" required="required"></textarea>
                            ...
                            <br>
                            <div id="success"></div>
                            <div class="form-group"><button class="btn btn-primary btn-xl" id="sendMessageButton" type="submit">등록하기</button></div>
                        </form>
                    </div>
                </div>
            </div>
